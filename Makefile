...
LDFLAGS=$(COMMONFLAGS) -fno-exceptions -ffunction-sections -fdata-sections -L$(LIBDIR) -nostartfiles -Wl,--gc-sections,-Tlinker.ld --specs=nano.specs -u __printf --specs=nosys.specs
LDLIBS+=-lm
LDLIBS+=-lstm32
LDLIBS+=-lc
LDLIBS+=-lgcc
